    ...
    <div className="border p-10 space-y-5">
      ...
      <div>
        {pedido.map((plato) => (
          <div
            key={plato.id}
            className="p-y-3 flex border-b last-of-type:border-0 items-center"
          >
            <div className="w-32">
              <Image
                width={400}
      ...
      <div className="md:flex md:items-center md:justify-between my-10">
        ...
        <button
          className="bg-indigo-600 hover:bg-indigo-800 text-white mt-5 md:mt-0 py-3 px-10 uppercase fontbold rounded"
          type="button"
